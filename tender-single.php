...
if (isset($_GET['id'])){
    $tender = Tender::find_by_id($_GET['id']);
    $company = $tender->company();
}else{
    redirect_to('tender.php');
}
...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <header id="main-navbar"  class="site-navbar container py-0 " role="banner">

      <!-- <div class="container"> -->
        <div class="row align-items-center">
          
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a class="navbar-brand" href="index.html" ><img src="images/logo.png" class="w-100 p-13">  </a></h1>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 style="color: white; font-weight: bolder;"><?= $company->company_name?></h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <ul class="nav nav-pills  nav-sidefeatures">
            <div class="col-lg-41">
          <li>
            <a  href="listings.html"><span class="fa fa-fire" ></span> Agriculture</a>
          </li>
          <li>
    ...
    <div class="clearfix visible-lg"></div>
        ...
        <div  class="col-lg-9" >
         ...
         <h3 style="font-weight: bolder;" ><?= $company->company_name?></h3>
          
        </div>
          
          
  <div style="border-color: rgb(129, 121, 121); border-radius:5px; background-color: white; height: 1000px;">
            
    <img src="images/72.jpg" class="img-thumbnail rounded-circle" style=" width: 150px; height: 150px; padding-bottom: 20px;  ">
    
  
    <div class="product-information"> <h4 style="font-weight: bolder;">BID DOCUMENT INFO</h4><!--/product-information--> 
      <div class="text p-4" >
        <h3 class="h5 text-black"><a href="tender-single.php"><?= $company->company_name?></a>  <p> <p id="review" style="background-color: rgb(69, 236, 111); font-weight: bolder; font-style: normal; color: white;border-radius: 5px; " >Open</p> </p> </h3>
        <i  id="review"  style="padding-bottom: 3px; border-color: darkblue; background-color: rgb(246, 246, 246); font-weight: bolder; font-style: normal; color: rgb(71, 71, 71);border-radius: 5px;" >RealEstates</i> </li> 
       ...
       <ul style="font-family: Arial, Helvetica, sans-serif; font-size: small; padding-top: 10px;">
         ...
         <li><span style="padding-right: 2px; color: red;" class="fa fa-calendar" ></span>Published on:-<?= $tender->published_on?><i style="color: rgb(24, 148, 24); font-weight: bolder;"> (3 hour ago)</i></li>
        ...
        <div class="fa fa-location-arrow "style="margin-right: 15px"> <?= $company->city . ", " . $company->country?> </div> <div class="fa fa-calendar" style=" margin-right: 15px">Posted on:- <i style="font-weight: bolder; color:red;" >3 hour ago</i></div> <div class="fa fa-clock">Remaing time:-<i style="color: red; font-weight: bolder;"> 5 days & 7 Hours</i> </div>
        </div> 
      </div>
          <p>-----------------------------------------------------------------------------------------------------------------------</p>
        <h6>
      ...
      <a href="tell:091 120130"><i c style="padding-top: 4px;"> [Buy Bid document]</i></a> <strong><?= $tender->price?> </strong> <br>
